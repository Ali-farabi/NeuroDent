// NeuroDent — CRM-система стоматологической клиники
// Этот файл является временным mock API (данные хранятся в localStorage)
// Когда backend (FastAPI + PostgreSQL) будет готов — каждая функция заменится реальным HTTP-запросом
//
